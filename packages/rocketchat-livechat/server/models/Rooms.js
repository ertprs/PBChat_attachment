...
//Added new method PBChat
RocketChat.models.Rooms.findOneByVisitorToken = function(visitorToken) {
    const query = {
        'v.token': visitorToken
    };
...
RocketChat.models.Rooms.findiOpenRoomForToday = function(departmentname, lastday) {
    const query = {
        open: true,
...
RocketChat.models.Rooms.getOpenRoomByCustID = function(CustID) {
    const query = {
        custid: CustID,
        open: true
    };
