Meteor.startup(function() {
	...
	RocketChat.settings.add('Livechat_Routing_Method_Health', 'Least_Amount', {
		type: 'select',
		group: 'Livechat',
		public: true,
		values: [
	...
	RocketChat.settings.add('Livechat_Routing_Method_NewCar', 'Least_Amount', {
		type: 'select',
		group: 'Livechat',
		public: true,
		values: [
	...
	RocketChat.settings.add('Livechat_Routing_Method_TermLife', 'Least_Amount', {
		type: 'select',
		group: 'Livechat',
		public: true,
		values: [
	...
	RocketChat.settings.add('Livechat_Routing_Method_Investments', 'Least_Amount', {
		type: 'select',
		group: 'Livechat',
		public: true,
		values: [
